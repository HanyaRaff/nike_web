...
const Hero = () => {
  ...
  return (
    <section
    id="home"
    className="w-full padding-x flex xl:flex-row flex-col min-h-screen 
    ...
    >
      ...
      w-full max-xl:padding-x pt-28">
        <p className="text-xl font-montserrat text-relative z-10 pr-10 text-coral-red">Our Summer Collection</p>
        ...
        text-lg leading-8 mt-6 mb-14 sm:max-w-sm ">Discover stylish Nike arrivals, quality comfort, and inovation for your
          active life.
        </p>
        <Button label="Show On " IconUrl={arrowRight}/>
